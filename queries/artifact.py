...
#         json.dumps(artifact.sampling_params.model_dump()),
#         json.dumps([ex.model_dump() for ex in artifact.fewshot_examples]) if artifact.fewshot_examples else None,
#         json.dumps(artifact.eval_scores or {})
#     )
#     return result
