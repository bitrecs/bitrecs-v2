...
async def evaluation_run_get_by_id(request: Request, evaluation_run_id: UUID) -> EvaluationRun:
...
@limiter.limit("60/minute")
async def evaluation_run_get_logs_by_id(request: Request, evaluation_run_id: UUID, type: EvaluationRunLogType) -> str:
